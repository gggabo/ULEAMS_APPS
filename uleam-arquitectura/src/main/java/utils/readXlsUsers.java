...
public class readXlsUsers implements Serializable {
	...
	public readXlsUsers(InputStream file) {
		super();
		this.file = file;
	}
	...
	public List<Usuario> getXlsUsersResultList() {
		...
		try {
		    ...
		    if(sheet.getSheetName().equals("DOC_REG")) {
		    	roles.add(RolController.getSpecificRolById(4L));
		    }else {
		    	roles.add(RolController.getSpecificRolById(5L));
		    }
		    			...
		    			if(cell.getCachedFormulaResultType()==CellType.STRING) {
		    				...
		    				if(cell.getStringCellValue().equals("0000000000")) {
			    				...
			    				if(i==0) {
			    					...
			    					user.setClave(DigestUtils.shaHex(cell.getStringCellValue()));
			    				}else if(i==1) {
