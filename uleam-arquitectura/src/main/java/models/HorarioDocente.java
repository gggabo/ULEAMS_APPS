...
public class HorarioDocente implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((docenteActividad == null) ? 0 : docenteActividad.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (dia == null) {
			...
			return false;
		if (docenteActividad == null) {
			if (other.docenteActividad != null)
				return false;
		} else if (!docenteActividad.equals(other.docenteActividad))
			return false;
		if (hora == null) {
			if (other.hora != null)
				return false;
	...
	public String toString() {
		return "HorarioDocente [dia=" + dia + ", hora=" + hora + ", actividad=" + actividad + "]";
	}
